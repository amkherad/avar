...
- Lists queues and sessions.
- Drag the vertical handle between the sidebar and downloads to resize (180–480 px).
- Hidden on Settings and Help pages.

## Downloads workspace

- **Toolbar** — add button and batch actions on the left; search on the right.
- **List** — scrollable download cards or table.
...
- **Console** — show or hide the log drawer.
...
| Mode | Behavior |
|------|----------|
| **Pinned** | Fixed column on the right; resizable (220–560 px) |
...
When the daemon is unreachable but cached data exists, a yellow banner warns that displayed information may be outdated.
