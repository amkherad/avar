...
View and remap keyboard shortcuts. Click a shortcut button, then press the new key combination. Press **Escape** to cancel recording.

Use **Reset all** to restore defaults.

Settings are stored locally in the browser or Electron profile (`localStorage`).
